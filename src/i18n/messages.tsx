...
export const messages = {
  zh: {
    ...
    "legend.windowNote": "曲线最多保留最近 {n} 个采样点，更早的数据会滚动移出。",
  ...
  en: {
    ...
    "legend.noteToggle": "Click a legend item to hide/show curves; click again to restore.",
    "legend.windowNote": "Curves keep at most the latest {n} samples; older data scrolls out.",
